                    ...
                    <div class="col">
                        <div class="formulaire">
                            ...
                            <?php
                                ...
                                <form method="post" action="recuperation/modifier_avis.php?id_av=<?php echo $av['id_avis']; ?>" name="formulaire_avis">
                                <div class="row ligne">
                                    <label>Nom</label>
                                ...
                                <div class="label">
                                     <input type="button" id="bouton_connexion" value="Modifier" onclick="test_avis();">
