                ...
                <div class="contenu">
                    ...
                    <div class="composite">
                        <div class="compo">
                            ...
                            <a name="selectionner" id="selectionner" class="btn btn-primary" href="composite_productGS.php" role="button">Selectionner</a>
                        </div>
                        <div class="compo ">
                            ...
                            <a name="selectionner" id="selectionner" class="btn btn-primary" href="composite_productGG.php" role="button">Selectionner</a>
                        </div>
                        <div class="compo ">
                            ...
                            <a name="selectionner" id="selectionner" class="btn btn-primary" href="composite_productGD.php" role="button">Selectionner</a>
                        </div>
                    </div>
                    
                </div>
                <div class="station_pro">
                <a name="selectionner" id="selectionner" class="btn btn-primary" style="float:right;"href="affiche_sous_categorie.php?id_sousC=<?php echo $_GET['id_sousC']; ?>" role="button">Cliquer ici pour voir toutes les ordinateurs gamers <i class="fas fa-arrow-circle-right    "></i></a>
                <div class="clear"></div>
                <br>
                </div>
            </div>
