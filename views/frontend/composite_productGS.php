...
$produitcomp=$produit_compose_core->affiche_single_produit_compose("GAME BOX SILVER");
$component=$produit_compose_core->get_product("","silver",'1');
//$defaut=$produit_compose_core->x_box_default_value("game box","silver");
//var_dump($component);
