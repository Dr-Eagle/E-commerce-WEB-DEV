...
$produitcomp=$produit_compose_core->affiche_single_produit_compose("GAME BOX GOLD");
$component=$produit_compose_core->get_product("","gold",'1');
//$defaut=$produit_compose_core->x_box_default_value("game box","gold");
//var_dump($component);
