...
<body>
    ...
    <div class="super_container">
        ...
        <div class="formulaire_connexion">
            <div class="container">
                <form method="post" action="recuperation/ajouter_client.php" name="formulaire_inscription">
                    <div class="label pp">
                        <p><img alt="photo de profil" src="" id="image_inscription" /></p>
                        <div class="select_image">
                            <a href="#"><input type="file" name="image_profil" id="url_photo"> ajouter une photo</a>
                        </div>
                    ...
                    <div class="label">
                        <label>Nom</label>
                        <input type="text" name="nom" id="nom_inscription">
                        <div class="clear"></div>
                    ...
                    <div class="label">
                        <label>Prenom</label>
                        <input type="text" name="prenom" id="prenom_inscription">
                        <div class="clear"></div>
                    ...
                    <div class="label">
                        <label>Email</label>
                        <input type="text" name="email" id="email_inscription">
                        <div class="clear"></div>
                    ...
                    <div class="label">
                        ...
                        <div class="mot-pass-cont">
                            <input type="password" id="mot_pass_inscription" name="mot_de_passe" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}">
                    ...
                    <div class="label">
                        ...
                        <div class="label">
                            ...
                            <input type="date" name="date_naissance" id="date_inscription" placeholder="17/03/1995">
                            <div class="clear"></div>
                        ...
                        <div class="label">
                            <input type="button" id="bouton_connexion" value="Créer" onclick="test_inscription();">
                        </div>
                        <p class="creer_compte"><a class="h6" href="#">Se connecter </a></p>
                </form>
            </div>
        </div>
        <!--body-->
