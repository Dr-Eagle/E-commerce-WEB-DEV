...
$produitcomp=$produit_compose_core->affiche_single_produit_compose("MAX BOX DIAMOND");
$component=$produit_compose_core->get_product("max box","diamand",'1');
$defaut=$produit_compose_core->x_box_default_value("max box","diamond");
//var_dump($defaut);
