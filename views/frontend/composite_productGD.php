...
$produitcomp=$produit_compose_core->affiche_single_produit_compose("GAME BOX DIAMOND");
$component=$produit_compose_core->get_product("","diamand",'1');
//$defaut=$produit_compose_core->x_box_default_value("game box","diamand");
//var_dump($defaut);
                    ...
                    <div class="composant">
                        ...
                        ?>
                            ...
                            <div class="descri">
                                ...
                                <p class="prix_single" data-nom="game box" data-type="<?=($produit->game_box != NULL)?$produit->game_box:"";?>" data-id="<?= $produit->id_produit;?>" data-prix="<?=$produit->prix;?>"><?=$produit->prix;?> TND</p>
                            </div>
