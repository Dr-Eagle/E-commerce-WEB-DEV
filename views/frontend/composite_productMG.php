...
$produitcomp=$produit_compose_core->affiche_single_produit_compose("MAX BOX GOLD");
$component=$produit_compose_core->get_product("max box","gold",'1');
$defaut=$produit_compose_core->x_box_default_value("max box","gold");
//var_dump($defaut);
