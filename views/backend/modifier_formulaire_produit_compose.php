            ...
            <div class="formulaire_produit">
                ...
                <?php
						foreach($produit_compose as $pc){
                            if($pc['id_produit_compose']==$_GET['id_proCom']){
						?>
                    <form action="recuperation/modifier_produit_compose.php?id_comp=<?php echo $_GET['id_proCom']; ?>" method="post" name="formulaire_produit_compose">
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="formulaire">
                                    ...
                                    <div class="label">
                                        ...
                                        <input type="text" id="nom_produit_compose" name="nom_produit_compose"  value="<?php echo $pc['nom_produit_compose']; ?>">
                                    ...
                                    <div class="label">
                                        ...
                                        <textarea id="description_courte_produit_compose" name="description_produit_compose"><?php echo $pc['description_produit_compose']; ?></textarea>
                                    ...
                                    <div class="label zone_tarif" style="justify-content: flex-start;">
                                        ...
                                        <input type="number" name="prix_produit_compose" class="tarif" id="tarif_regulier_compose" value="<?php echo $pc['prix_produit_compose']; ?>">
                                        <span>DT</span>
                                ...
                                <div class="publier">
                                    <input type="button" value="Modifier un produit compose" class="publier_input" onclick="test_produit_compose();">
                                </div>
                            </div>
                        </div>
