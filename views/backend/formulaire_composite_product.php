    ...
    <div class="super_container">
        ...
        <div class="space_work">
            ...
            <div class="formulaire_composite ">
                <h2>Ajouter un composite product</h2>
                <form method="post" action="recuperation/ajouter_composite_product.php" name="formulaire_composite_product">
                    ...
                    <div class="composite">
                        <div class="compo">
                            <div class="label">
                                ...
                                <input type="text" name="nom_option1" id="nom_option1">
                                <div class="clear"></div>
                            ...
                            <div class="label">
                                ...
                                <textarea name="description_option1" id="description_option1" cols="30" rows="10"></textarea>
                                <div class="clear"></div>
                            ...
                            <div class="label">
                                <label>Prix</label>
                                <input type="number" name="prix_option1" id="prix_option1">
                                <div class="clear"></div>
                        ...
                        <div class="compo">
                            <div class="label">
                                ...
                                <input type="text" name="nom_option2" id="nom_option2">
                                <div class="clear"></div>
                            ...
                            <div class="label">
                                <label>Description </label>
                                <textarea name="description_option2" id="description_option2" cols="30" rows="10"></textarea>
                                <div class="clear"></div>
                            ...
                            <div class="label">
                                <label>Prix</label>
                                <input type="number" name="prix_option2" id="prix_option2">
                                <div class="clear"></div>
                        ...
                        <div class="compo">
                            <div class="label">
                                ...
                                <input type="text" name="nom_option3" id="nom_option3">
                                <div class="clear"></div>
                            ...
                            <div class="label">
                                <label>Description </label>
                                <textarea name="description_option3" id="description_option3" cols="30" rows="10"></textarea>
                                <div class="clear"></div>
                            ...
                            <div class="label">
                                <label>Prix</label>
                                <input type="number" name="prix_option3" id="prix_option3">
                                <div class="clear"></div>
                    ...
                    <div class="label">
                        <input type="button" id="bouton_ajouter" value="Ajouter " onclick="text_formulaire_composite();">
                    </div>
