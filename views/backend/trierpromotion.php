           ...
           <form method="post" action="trierpromotion.php">
            ...
            <form action="" method="post">
                <table class="table table-striped table-inverse affichage_produit">
                    ...
                    <tbody>
                    <?php
                    if($_POST['recherche']=='date'){
                        $liste=promo_core::tripromotion();
                    }else{
                                            $liste=promo_core::trireducpromotion();
                    ...
                    foreach($Evenements as $clt){
                        ?>
                         <tr>
                            ...
                            <td> 
                                    <a class="btn btn-danger" href="recuperation/supprimer_promo.php?id=<?PHP echo $clt['idpro'];?>">Supprimer</a>
                                    <a class="btn btn-warning" href="modifier_promo.php?id=<?PHP echo $clt['idpro'];?>">Modifier</a>
                            </td>
                        </tr>
                        <?php
                    }
